...
def load_data(): 
    ...
    dakar = pd.read_csv(os.path.join(base_path, "dakar_new2.csv"), parse_dates=["Datetime", "Date"])
    region = pd.read_csv(os.path.join(base_path, "region_new2.csv"), parse_dates=["Datetime", "Date"])
    return dakar, region
